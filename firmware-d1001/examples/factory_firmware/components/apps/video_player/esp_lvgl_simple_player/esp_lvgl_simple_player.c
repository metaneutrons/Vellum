...
static lv_obj_t * create_lvgl_objects(lv_obj_t * screen)
{
    ...
    lv_obj_set_size(cont_col, player_ctx.screen_width, player_ctx.screen_height - 80);
    ...
    lv_obj_align_to(cont_row,cont_col,LV_ALIGN_OUT_BOTTOM_MID,0,0);
...
static void show_video_task(void *arg)
{
    ...
    if (player_ctx.auto_width || player_ctx.auto_height) {
        ...
        lv_obj_set_size(player_ctx.main, w, h-80);
    }

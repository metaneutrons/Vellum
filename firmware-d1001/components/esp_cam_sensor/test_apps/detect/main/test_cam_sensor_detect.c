...
#elif CONFIG_CAMERA_BF2253
#include "bf2253.h"
#define SCCB0_CAM_DEVICE_ADDR BF2253_SCCB_ADDR
#elif CONFIG_CAMERA_OV02B10
#include "ov02b10.h"
#define SCCB0_CAM_DEVICE_ADDR OV02B10_SCCB_ADDR
#else
...
TEST_CASE("Camera sensor detect test", "[video]")
{
    ...
    TEST_ESP_OK(esp_cam_sensor_del_dev(cam0));
#elif CONFIG_CAMERA_BF2253
    esp_cam_sensor_device_t *cam0 = bf2253_detect(&cam0_config);
    TEST_ASSERT_MESSAGE(cam0 != NULL, "detect fail");

    TEST_ESP_OK(esp_cam_sensor_del_dev(cam0));
#elif CONFIG_CAMERA_OV02B10
    esp_cam_sensor_device_t *cam0 = ov02b10_detect(&cam0_config);
    TEST_ASSERT_MESSAGE(cam0 != NULL, "detect fail");

  ...
  return (
    <div className="border rounded-lg overflow-hidden" style={{ width: 280, height: 168 }}>
      <svg viewBox="0 0 800 480" width="280" height="168" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="100" y="182" fill={T.slotText} fontSize="16" fontFamily="sans-serif" opacity="0.8">
          10:00 – 11:00
        </text>
        {/* Second event */}
        ...
        <line
          ...
          x2="720"
          y2="340"
          stroke={T.slotSecondary}
          strokeWidth="1"
          opacity="0.3"
        />
        <text x="20" y="345" fill={T.slotSecondary} fontSize="16" fontFamily="sans-serif">
          12:00
        </text>
        <line
          x1="80"
          ...
          opacity="0.3"
        />
        <text x="20" y="405" fill={T.slotSecondary} fontSize="16" fontFamily="sans-serif">
          13:00
        </text>
        {/* Footer */}
        <text x="20" y="465" fill={T.footerText} fontSize="16" fontFamily="sans-serif">
          Updated: 10:30
        </text>
      </svg>
    </div>

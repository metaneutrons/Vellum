...
esp_err_t lcd_jd9365_init(const lcd_jd9365_config_t *config, esp_lcd_panel_handle_t *ret_panel)
{
    ...
    /* DPI pixel config */
    esp_lcd_dpi_panel_config_t dpi_cfg = JD9365_8_800_1280_PANEL_60HZ_DPI_CONFIG(LCD_COLOR_PIXEL_FORMAT_RGB565);
    dpi_cfg.num_fbs = config->num_fb;
    ...
    ESP_RETURN_ON_ERROR(esp_lcd_new_panel_jd9365_8(io, &dev_cfg, ret_panel), TAG, "JD9365 panel failed");
